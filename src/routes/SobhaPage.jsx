...
const SobhaPage = () => {
  ...
  const handleViewProperty = (property) => {
    const propertySlug = property.house_name
      .toLowerCase()
      .replace(/\s+/g, "-");
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#ffffff] via-[#f1f1ec] to-[#eeead5] mt-20">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="text-center mb-10">
          <h2 className="text-3xl underline md:text-4xl font-bold text-[#0e2f4e] mt-10 mb-10 text-center">
            Top Properties in {formattedArea.toUpperCase().replace(/_/g, " ")}
          </h2>
          <p className="text-gray-600 max-w-xl mx-auto mb-10">
            Dive into our handpicked collection of residential properties —
            verified, beautifully crafted, and perfectly located.
          </p>
        </div>
